<?php 
    ...
    $updateTime = (strtotime(date('Y-m-d H:i:s'))-strtotime($post[0]->last_date))/3600;
            ...
            <div class="post__container">
                <div class="post__main">
                    <div class="post__content__one">
                        <img src="<?php echo base_url($post[0]->avatar) ?>" class="img__avatar__82" alt="">
                        <label for="" class="user_level"><?php echo $post[0]->level_name ?></label>
                        <div class="UpAndDown">
                            <?php if($currentVote == 0): ?>
                                <a href="<?php if(session()->get('isLogged')) echo base_url('Discussion/upScore/'.$post[0]->post_id) ?>">
                                    <i class="fas fa-caret-up" id="button__score"></i>
                                </a>
                                <label for=""><?php echo $post[0]->score ?></label>
                                <a href="<?php if(session()->get('isLogged')) echo base_url('Discussion/downScore/'.$post[0]->post_id) ?>">
                    ...
                    <div class="post__content__two">
                        <div class="post__block__content">
                            <div class="post__block__content__first">
                                <label><?php echo $post[0]->title ?></label>
                                ...
                                <?php if((session()->get('isLogged')) != null): ?>
                                    <div class="dropdown__postblock">
                                        ...
                                        <?php if(session()->get('user_id') == $post[0]->user_id): ?>
                                            <div class="arrow-up" id="Arrow-up"></div>
                                            <div class="dropdown-content__postblock" id="Dropdown-content__postblock">
                                                <a href="<?php echo base_url('Discussion/EditPost/'.$post[0]->post_id) ?>">Sửa</a>
                                                <a href="<?php echo base_url('Discussion/DeletePost/'.$post[0]->post_id) ?>">Xóa</a>
                        ...
                        <div class="post__block__detail">
                            <label for="">Tác giả: <?php echo "<a href='".base_url('profile/'.$post[0]->username)."'>".$post[0]->username."</a>" ?></label>
                            ...
                            <?php endif ?>
                            <label for="">  
                                Lượt xem: <?php echo $post[0]->view_number ?>
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <?php for($i = 0; $i < $numberofComments; $i++): ?>
                        <div class="post__comment__block">
                            <div class="post__comment__block__first">
                                <div class="UpAndDown">
                                    <a href="<?php if(session()->get('isLogged')) echo base_url('Discussion/upScoreCmt/'.$comments[$i]->cmt_id.'/'.$post[0]->post_id) ?>">
                                        <i class="fas fa-caret-up" id="button__score"></i>
                                    </a>
                                    <label for=""><?php echo $comments[$i]->cmt_score ?></label>
                                    <a href="<?php if(session()->get('isLogged')) echo base_url('Discussion/downScoreCmt/'.$comments[$i]->cmt_id.'/'.$post[0]->post_id) ?>">
                                        <i class="fas fa-caret-down" id="button__score"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="post__comment__block__second">
                                <div class="comment__block__second__one">
                                    ...
                                    <div>
                                        <label for=""><?php echo "<a href='".base_url('profile/'.$comments[$i]->username)."'>".$comments[$i]->username."</a>" ?></label>
                                ...
                                <div class="comment__block__second__two">
                                    <p>
                                        <?php echo $comments[$i]->cmt_content ?>
                                    </p>
                                </div>
                            </div>
                        </div>
